...
FEW_SHOT_PROMPT = """
Context: Mary's spouse is Casey.
Claim: Casey is the wife of Mary.
Verdict: TRUE

Context: Mary's parent is Casey.
Claim: Casey is the husband of Mary.
Verdict: TRUE

Context: Spain is east of Portugal. France is east of Spain.
Claim: Portugal is west of France.
Verdict: TRUE

Context: No background facts available.
Claim: She has children.
Verdict: FALSE

Context: No background facts available.
Claim: She doesn't have children.
Verdict: TRUE
...
def build_prompt(claim: str, kg_lines: list[str]) -> tuple[list[dict], list[str]]:
	...
	return [
		{"role": "system", "content": "Based on the examples, answer TRUE or FALSE."},
