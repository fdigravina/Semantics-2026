...
STATE_FILE       = "gemma_checkpoint.json"
...
def build_prompt(claim: str, kg_lines: list[str]) -> tuple[list[dict], list[str]]:
	...
	instruction = (
		...
		f"Context:\n{kg_section}\n"
		f"Claim: {claim}\n"
		f"Answer with exactly Verdict: TRUE or Verdict: FALSE"
	)
	
	return [
		{"role": "system", "content": "Based on the examples and your knowledge, answer TRUE or FALSE."},
...
_sec("Inizializzazione Google API Client")
t0 = time.time()
